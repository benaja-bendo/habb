...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Creation d'un commercial</h5>
            <!--end::Title-->
            <!--begin::Separator-->
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <!--begin::Card-->
        <div class="card">
        <form id="kt_form_1" class="form" method="POST" action="{{ route('commerciaux.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
             ...
             <div class="form-group row mt-3">
              ...
              <div class="col-lg-3">
               <div class="input-group">
                ...
                <input type="text" name="password" class="form-control" placeholder="" value="Password" disabled/>
               </div>
              </div>
             </div>
             ...
             <div class="form-group row">
              ...
              <div class="col-lg-3">
               <input type="text" id="kt_inputmask_3" name="telephone" class="form-control"/>
              ...
              <div class="col-lg-3">
               <div class="input-group">
                <input type="text" name="adresse" class="form-control" placeholder="Enter votre address"/>
                <div class="input-group-append">
              ...
              <div class="col-lg-3">
               <div class="radio-inline">
                <label class="radio radio-solid">
                 <input type="radio" name="genre" checked="checked" value="h"/>
                 <span></span>
                 Homme
                </label>
                <label class="radio radio-solid">
