            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="{{ route('home') }}"><img src="images/habitel Npole.png" alt="#" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        <ul class="costomer">
                            <li>Téléphone   <a href="#">+242 06 6443279</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="banner_main">
            <div class="container-fluid">
                <div class="row d_flex">
                    <div class="col-md-5">
                        <div class="text-bg">
                            <span>Application <br> et logiciel</span>
                            <h1>HABITEL NPOLO</h1>
                            <p>Une solution tout en un.</p>
                            <a href="#contact">Connectez-vous!</a>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="text-img">
...
<div id="why" class="weare">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Qui <span class="white">nous sommes</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="testimonial">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Nos <span class="white">Fournisseurs</span></h2>
                    <p>Nous travaillons avec plusieurs structrure citer ci-dessous<br>
                    </p>
                </div>
            </div>
        </div>
...
<div  class="asked_main">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>Nos <span class="white"> differents services</span></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ask_box">
                    ...
                    <div class="simpaly">
                        <div class="slider"><span>+</span><a href="#">
                                Vente des produitd vessailles</a>
                        </div>
                        <div class="content">
                            <p> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its l
                                ore-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages
...
<div id="contact" class="contact">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="titlepage">
                    <h2>Contactez <span class="white">Nous</span></h2>
                </div>
                <div class="cont">
                     <span>Adressez-nous
                     Toutes nos </br>
                         Demande par ce formulaire</span>
                    <a href="#">Merci</a>
                </div>
            </div>
            <div class="col-md-6">
